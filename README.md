...
- **Custom tools** (installed to `$PREFIX/bin`):
  ...
  - `shell` — Shizuku-backed ADB shell: `shell setup` to install rish and verify the server, bare `shell` to enter the shell, `shell scripts` to run pre-built ADB scripts
